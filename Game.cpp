...
void Game::CreateDeviceDependentResources()
{
	...
	//load Textures
	CreateDDSTextureFromFile(device, L"wood.dds", nullptr, m_texture1.ReleaseAndGetAddressOf());
    CreateDDSTextureFromFile(device, L"seafloor.dds", nullptr, m_texture2.ReleaseAndGetAddressOf());
    CreateDDSTextureFromFile(device, L"grass_tex.dds", nullptr, m_texture3.ReleaseAndGetAddressOf());
